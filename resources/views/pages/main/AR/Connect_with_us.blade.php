...
<link rel="stylesheet" href="{{ asset('css/contact_us_ar.css') }}">
    ...
    <section class="contact-section">
        ...
        <div class="section-header">
            <div class="container">
                <h2>تواصل معنا</h2>
                <p>
                    مرحبًا بكم في صفحة التواصل معنا! في ريحان, نؤمن بأهمية التواصل والتفاعل مع مجتمعنا الرائع. إننا نؤمن
                    أن بناء مستقبل مشرق يتطلب تواصل فعّال وتشارك مستمر بيننا وبينكم.</p>
            </div>
        </div>
                ...
                <div class="contact-form">
                    <form action="" id="contact-form">
                        ...
                        <div class="input-box">
                            ...
                            <span>...أكنب رسالتك هنا</span>
                        </div>

                        <div class="input-box">
                            <input type="submit" value="أرسال" name="">
                        </div>
                    </form>
                </div>
