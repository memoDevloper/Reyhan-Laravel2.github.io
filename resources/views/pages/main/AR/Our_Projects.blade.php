...
<link rel="stylesheet" href="{{ asset('css/our_prjects_ar.css') }}">
...
<body>
    ...
    <div class="our-project-top-part">
        <div class="project-hero-text">مشاريعنا</div>
        <div class="sector-sub-w">قطاعتنا</div>
                        ...
                        <div class="card-slider" id="cardSlider">
                            <div class="card">
                                <a href="/Education-sector" class="Icones-style">
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">التعليم</h2>
                                        <!--1--->
                                    </div>
                                </a>
                            </div>
                            <div class="card">
                                <a href="/Protection-sector" class="Icones-style">
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">الحماية</h2>
                                        <!--2--->
                                    </div>
                                </a>
                            </div>
                            <div class="card">
                                <a href="/Health-sector" class="Icones-style" style="padding-top: 3px;">
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">الصحة</h2>
                                        <!--3--->
                                    </div>
                                </a>
                            </div>
                            <div class="card">
                                <a href="/Peacebuilding-sector" style="font-size: 17px !important;"
                                    ...
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">المناصرة، التماسك
                                            الاجتماعي، وبناء السلام</h2>
                                        <!--4--->
                                    </div>
                                </a>
                            </div>
                            <div class="card">
                                <a href="/Securing-food-sector" class="Icones-style">
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">تأمين الغذاء
                                            وسبل العيش</h2>
                                        <!--5--->
                                    </div>
                                </a>
                            ...
                            <div class="card"><a href="/Human-rights-sector" class="Icones-style down-medL">
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">حقوق الإنسان
                                            والديمقراطية</h2>
                                        <!--6--->
                                    </div>
                                </a>
                            ...
                            <div class="card"><a href="/Non-food-products-sector" style="font-size: 19px !important;"
                                    ...
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">المأوى والمواد غير
                                            الغذائية</h2>
                                        <!--7--->
                                    </div>
                                </a>
                            ...
                            <div class="card"><a href="/Environment-sector" class="Icones-style">
                                    <div class="single-list-topics-content">
                                        ...
                                        <h2 class="Icones-style">البيئة وتغير
                                            المناخ</h2>
                                        <!--9--->
                                    </div>
                                </a>
                            ...
                            <ul class="Postlar">
                                <li>
                                    <div class="div-3 ">
                                        ...
                                        <div class="div-4">
                                            <div class="div-5">
                                                <div class="text-wrapper-2">المساعدات الغذائية</div>
                                                <p class="p">
                                                    حملات الغذائية هي مبادرات إنسانية تستهدف توفير الدعم الغذائي للفئات المحتاجة في المجتمع. يقوم المتطوعون والمؤسسات الخيرية بجمع الطعام وتوزيعه على الأسر ذات الاحتياجات الخاصة، سواء كانت نتيجة للفقر أو الكوارث الطبيعية أو الأزمات الاقتصادية.
                                                </p>
                                            </div>
                                            <div class="frame-wrapper">
                                                <div class="div-6 div-6-1">
                                                    <div class="text-wrapper-3">تبرع الأن</div>
                                ...
                                <li>
                                    <div class="div-8">
                                        ...
                                        <div class="div-4">
                                            <div class="div-5">
                                                <div class="text-wrapper-2">رعاية اليتيم                                                </div>
                                                <p class="p">راعي اليتيم يشكل رمزاً للرعاية الإنسانية، حيث يسعى بتفانٍ وحنان إلى توفير الدعم الشامل والرعاية الصحية والتعليمية للأيتام، محققاً تأثيرًا إيجابيًا على حياتهم ومستقبلهم، ويسهم في بناء مجتمع أكثر رعاية وتضامنًا.
                                                </p>
                                            </div>
                                            <div class="frame-wrapper">
                                ...
                                <li>
                                    <div class="div-8 div-8-2">
                                        ...
                                        <div class="div-4">
                                            <div class="div-5">
                                                <div class="text-wrapper-2">تدريب العمال</div>
                                                <p class="p">تدريب العمال يلعب دورًا حيويًا في تعزيز المهارات ورفع كفاءة العمل، حيث يسعى إلى تحسين أداء الفرد وتمكينه من التكيف مع التحديات العملية الحديثة. يشمل تدريب العمال نقل المعرفة وتطوير المهارات الفنية واللينة، مما يعزز الإنتاجية ويعمل على بناء فريق عمل قوي ومؤهل.
                                                </p>
                                            </div>
                                            <div class="frame-wrapper">
        ...
        <div class="container">
            <div class="Non_FoodPart">
                <div class="leftPart_project">
                    ...
                    <div class="text_2">
                        <h2>المأوى والمواد غير الغذائية</h2>
                    </div>
                </div>
                <div class="openIcone">
